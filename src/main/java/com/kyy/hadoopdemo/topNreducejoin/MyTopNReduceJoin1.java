 ...
 */
public class MyTopNReduceJoin1 {
    public static void main(String[] args) throws Exception {
        ...
        // map task
        job.setMapperClass(TMapper1.class);
        ...
        // reduce task
        job.setReducerClass(TReducer1.class);
